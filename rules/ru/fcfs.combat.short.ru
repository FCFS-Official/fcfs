...
10.Падение соперника, вызванное разрешённым ударом рукой, ногой или коленом, при котором соперник теряет равновесие и касается ковра любой частью тела, приравнивается к броску.
11.Падение, не вызванное действием соперника (например, потеря равновесия без контакта), не засчитывается как бросок.

<a id="short-6"></a>

# 6. Борьба и удары в партере
